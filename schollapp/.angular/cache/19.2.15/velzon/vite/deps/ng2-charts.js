...
} from "./chunk-QAIQGVYC.js";
import {
  Chart,
  defaults,
  registerables
} from "./chunk-B6I2ESYC.js";
import {
  Directive,
  ElementRef,
  EventEmitter,
...
var reIsNative = RegExp("^" + funcToString2.call(hasOwnProperty).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
