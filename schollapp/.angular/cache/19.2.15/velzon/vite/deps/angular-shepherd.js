...
var getElementRects = function getElementRects2(_ref) {
  return __async(this, null, function* () {
    let {
      reference,
      floating,
  ...
  cancel() {
    return __async(this, null, function* () {
      if (this.options.confirmCancel) {
        ...
        const stopTour = confirmCancelIsFunction ? yield this.options.confirmCancel() : window.confirm(cancelMessage);
        if (stopTour) {
          this._done("cancel");
        }
      } else {
