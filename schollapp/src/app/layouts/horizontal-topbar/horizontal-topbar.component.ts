...
export class HorizontalTopbarComponent implements OnInit {
  ...
  constructor(private router: Router, public translate: TranslateService, public authService: AuthenticationService) {
  ...
  ngOnInit(): void {
    ...
    this.menuItems = this.obtenerMenuItems();
  }
  ...
  obtenerMenuItems() {
    let menu = this.authService.getDecodedToken();
    return menu.user.Menus;
  }
}
