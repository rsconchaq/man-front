    ...
    bootstrap: [AppComponent], imports: [TranslateModule.forRoot({
        ...
        JwtModule.forRoot({
            config: {
                ...
                allowedDomains: ['localhost:3000', 'localhost:4200', 'localhost:8080'], // Add your API domains
                disallowedRoutes: ['localhost:3000/auth/login'] // Routes where JWT shouldn't be sent
            }
        }),
